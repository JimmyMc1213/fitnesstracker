import type { AppState, SundayCheckInWeekRecord, WeekFocusCommitment } from "@newyouai/types";

import { capSundayCheckInHistory } from "../sync/sundayCheckInHistoryMerge";
...
export function normalizeSundayCheckInHistory(raw: unknown): SundayCheckInWeekRecord[] {
  ...
  return capSundayCheckInHistory(out.sort((a, b) => a.weekStartKey.localeCompare(b.weekStartKey)));
}
