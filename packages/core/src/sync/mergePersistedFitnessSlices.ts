import type { PersistedFitnessSlice, WorkoutState } from "@newyouai/types";
import { nutritionPresetFingerprint } from "../nutrition/nutritionTotals";
import { dedupeHabitTemplates, stripNutritionProgrammingHabits } from "./habitsMerge";
import { mergeExerciseSessionHistoryByKey } from "./exerciseSessionHistoryMerge";
import { mergeWorkoutHistory } from "./workoutHistoryMerge";
import { mergeExercisePersonalBests } from "./workoutSummaryMerge";
import {
...
import { mergeSundayCheckInHistory } from "./sundayCheckInHistoryMerge";
import { normalizeExperienceLevel } from "./experienceLevel";
import { normalizeEquipmentSetup } from "./equipmentSetup";
import { isLegacyDemoWorkoutTemplates, sanitizeWorkoutTemplates } from "./workoutTemplates";
import type {
  AdjustmentEvent,
  EquipmentSetup,
  ExperienceLevel,
...
function mergeFitnessStreakSnapshot(
  local: import("@newyouai/types").FitnessStreakSnapshot,
  remote: import("@newyouai/types").FitnessStreakSnapshot,
): import("@newyouai/types").FitnessStreakSnapshot {
...
function mergeStreakSessionBaseline(
  local: import("@newyouai/types").StreakSessionBaseline | null,
  remote: import("@newyouai/types").StreakSessionBaseline | null,
): import("@newyouai/types").StreakSessionBaseline | null {
