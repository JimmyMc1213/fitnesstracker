/** Keep in sync with supabase/functions/future-you-upload/guards.ts */
...
/** Storage path for a source selfie: `users/{userId}/source/{uploadId}.{ext}`. */
...
/** Parse a browser-style `data:image/...;base64,...` string from onboarding photo pickers. */
