    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-[820px] px-7 pb-20 pt-14">
        <section className="space-y-4 text-base font-medium leading-relaxed text-ink-secondary">
          ...
          <h2 className="mt-11 text-xl font-extrabold tracking-tight text-ink">3. Information we collect</h2>
          <ul className="list-disc space-y-2 pl-6">
            <li>
          ...
          <h2 className="mt-11 text-xl font-extrabold tracking-tight text-ink">
            4. Future You and AI processing
          </h2>
          <p>
          ...
          <h2 className="mt-11 text-xl font-extrabold tracking-tight text-ink">5. Sensitive data</h2>
          <p>
          ...
          <h2 className="mt-11 text-xl font-extrabold tracking-tight text-ink">8. Retention and deletion</h2>
          <p>
          ...
          <h2 className="mt-11 text-xl font-extrabold tracking-tight text-ink">9. Your rights (GDPR / UK GDPR)</h2>
          ...
          <h2 className="mt-11 text-xl font-extrabold tracking-tight text-ink">11. Children&apos;s privacy</h2>
          <p>
          ...
          <h2 className="mt-11 text-xl font-extrabold tracking-tight text-ink">12. Cookies and local storage</h2>
          <p>
          ...
          <h2 className="mt-11 text-xl font-extrabold tracking-tight text-ink">13. Security</h2>
          <p>
          ...
          <h2 className="mt-11 text-xl font-extrabold tracking-tight text-ink">14. Changes to this policy</h2>
          <p>
