  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-16 prose prose-invert max-w-none">
      ...
      <section className="mt-8 space-y-4 text-muted leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-foreground">4. Future You disclaimer</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-foreground">6. Subscriptions and billing</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-foreground">13. Governing law and disputes</h2>
        <p>
