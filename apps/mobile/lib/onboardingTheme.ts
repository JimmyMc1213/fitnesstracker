...
const darkOnboardingTheme: OnboardingThemeTokens = {
  ...
  welcomeCtaBg: "#ffffff",
  welcomeCtaFg: "#0a0a0a",
  /** Solid stops — kept close to `--card` so the sheen reads subtle on RN SVG. */
  gradientCardStops: [
    { color: "#181818", offset: 0 },
    { color: "#161616", offset: 0.48 },
    { color: "#131313", offset: 1 },
  ],
  gradientCardShadow: {
    color: "#000000",
  ...
  cardTopHighlight: "rgba(255, 255, 255, 0.02)",
  cardBorder: "#2a2a2a",
...
const lightOnboardingTheme: OnboardingThemeTokens = {
  ...
  gradientCardStops: [
    ...
    { color: "#fafafa", offset: 0.52 },
    { color: "#f4f4f6", offset: 1 },
  ],
  gradientCardShadow: {
    color: "#000000",
    offset: { width: 0, height: 6 },
  ...
  cardTopHighlight: "rgba(255, 255, 255, 0.72)",
  cardBorder: "#e0e0e0",
