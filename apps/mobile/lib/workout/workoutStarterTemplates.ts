    ...
    days: [
      {
        ...
        exercises: [
          ex("Barbell deadlift", { label: "Barbell", setCount: 3 }),
    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex("Standing calf raise", { label: "Machine", setCount: 3 }),
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex("Seated calf raise", { label: "Machine", setCount: 3 }),
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        exercises: [
          ex("Barbell overhead press", { label: "Barbell", setCount: 3 }),
    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex("Bodyweight squat", { setCount: 3 }),
  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ex("Trap bar deadlift", { label: "Trap bar", setCount: 3 }),
          ex("Bulgarian split squat", { label: "Dumbbell", setCount: 3 }),
          ex("Leg extension", { label: "Machine", setCount: 3 }),
          ex("Seated leg curl", { label: "Machine", setCount: 3 }),
          ex("Barbell hip thrust", { label: "Barbell", setCount: 3 }),
