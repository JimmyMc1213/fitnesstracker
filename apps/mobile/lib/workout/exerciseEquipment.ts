import type { EquipmentSetup, WorkoutExercise } from "@newyouai/types";
...
export function adaptExerciseForEquipment(exercise: WorkoutExercise, setup: EquipmentSetup): WorkoutExercise {
