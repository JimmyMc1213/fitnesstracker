...
- [ ] Fresh install → cannot reach theme picker or step 1 without signing in
- [ ] After sign-in → onboarding starts (or resumes draft)
- [ ] Sign out mid-onboarding → kicked to auth, draft preserved for same account
...
**Test / should be there:**
- [ ] Every 10c chip you show in UI has a matching id in this file
- [ ] Generics exist for cut, bulk, maintain
- [ ] Specifics exist for cut (m/f), bulk, maintain
- [ ] No duplicate ids
...
**Test / should be there:**
- [ ] Output always includes “same person” / identity language
- [ ] Maintain goal → output includes “subtle” / no dramatic change
- [ ] Wedding dress / veins motivations → different fragments in output
- [ ] Timeline string (e.g. “3 months”) appears in prompt when provided
...
**Test / should be there:**
- [ ] `npm test` passes for prompt builder
- [ ] Tests fail if someone removes maintain guardrail or identity line
...
**Test / should be there:**
- [ ] Manual/curl test with real selfie → result image in Storage
- [ ] Job row ends as `ready` with result_path
...
- [ ] You’re happy enough to ship v1 (knowing report button exists)
...
**Test / should be there:**
- [ ] Cut/bulk: after step 10 → 10b appears
- [ ] Maintain: after step 8 → 10b (skips 9–10)
- [ ] Continue with photo → goes to 10c
- [ ] Skip → goes to 11, no job started
- [ ] Age 13–17: blurred/blocked + “available at 18” message, no upload
- [ ] Age 18+: normal upload works
...
**Test / should be there:**
- [x] Cannot navigate back to change goal after step 11
- [x] Settings goal edit still works post-onboarding (separate)
